...
import { useRoute } from 'vue-router'; // ✅ 1. เพิ่มบรรทัดนี้

const route = useRoute(); // ✅ 2. เพิ่มบรรทัดนี้
    ...
    return [
        {
            ...
            items: [
                // ตอนนี้ route.path จะใช้งานได้แล้ว ไม่จอขาวครับ
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'งานที่ต้องทำ', path: '/my-tasks', icon: 'ClipboardCheckIcon', isMock: true }
            ]
        },
        {
